...
import ru.geekbrains.stargame.screen.sprites.Life;
...
public class GameScreen extends Base2DScreen implements ActionListener {
    ...
    public void show() {
        ...
        for (int i = 0; i < lives.length; i++) {
            Life life = new Life(new TextureRegion(new Texture("textures/life.png")));
            life.setBottom(life.getBottom() + 0.05f*i);
            lives[i] = life;
        }
    ...
    public void printInfo() {
        ...
        for (int i = 0; i < lives.length; i++) {
            float  cel = 100/5;
            if (cel*(i + 1) > mainShip.getHp() ){
                lives[i].destroy();
            }else{
                lives[i].flushDestroy();
            }
        }
